...
var Influx = require('influx'),
    ...
    impl = {
        ...
        validateConfig: function (scriptConfig) {
            ...
            // //set match to false if none already
            // if(!scriptConfig[constants.CONFIG_SHOW_MATCHES]) {
            //     scriptConfig[constants.CONFIG_SHOW_MATCHES] = "false";
            // }
        ...
        reportResults: function (instance, influxReporter, testReport) {
            ...
            while (samples < testReport.latencies.length) {
             ...
             //   console.log('asdf  ' + JSON.stringify(instance.config['influx'].matches) + ' ' + JSON.stringify(instance.config[constants.CONFIG_STATIC_TAGS].testName) + 'CHANGE ' + JSON.stringify(instance));


                if (JSON.stringify(instance.config[constants.CONFIG_INFLUX].matches) === '"show"') {
